...
Use seqOutBias to compute mappability for the given read length and the k-mer that corresponds to each possible read alignment position.
...
```{r engine='bash', eval=F, echo=TRUE}
# installation code here? i just got the binaries from Mike though 
