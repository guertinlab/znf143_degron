...
Please see ChIP-seq analysis vignette for processing of ZNF143-dTAG ChIP-seq samples and identification of functional ZNF143 binding sites.
...
After running the model, the results were compiled into `combinedResults.txt.gz` and plotted with the following code chunk:
