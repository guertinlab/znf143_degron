...
# Heatmaps of promoter-enriched motifs (Fig. 5B, 6A, S8)

## Defining "promoter-enriched" motifs

We called sense- and anti-sense TSSs for every gene in our control samples in order to establish rough boundaries for "promoters". Within these boundaries, we performed de novo motif analysis with MEME and matched to the JASPAR database to identify which transcription factor motifs were most enriched. 



## FIMO for specific motifs 

YY1, SP1, ETS, Nrf1, bZIP
