...
The analysis follows the published figures, which may differ from the preprint figures in labeling and content. This vignette is copied largely from the ATAC-seq vignette for the GeneX course (https://github.com/guertinlab/genex/tree/main).
